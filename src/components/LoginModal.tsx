...
export const LoginModal: React.FC<LoginModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-slate-900 border border-purple-800/50 rounded-2xl max-w-md w-full p-6 md:p-8 shadow-2xl relative space-y-6"
      ...
      >
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex p-3 bg-purple-950/50 border border-purple-800/40 rounded-2xl text-purple-400">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Ingresa tu usuario (ej: director)"
                className="w-full bg-slate-950 border border-slate-700/80 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-rose-500 transition-colors"
              />
            </div>
          </div>
